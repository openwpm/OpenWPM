...
from ..utilities.platform_utils import get_firefox_binary_path, get_geckodriver_executable_path
...
def deploy_firefox(status_queue, browser_params, manager_params,
    ...
    driver = webdriver.Firefox(firefox_profile=fp, firefox_binary=fb, executable_path=geckodriver_executable_path,
