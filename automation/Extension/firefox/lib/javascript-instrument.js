  ...
  pageMod.PageMod({
    ...
    onAttach: function onAttach(worker) {
      ...
      function processCallsAndValues(data) {
        ...
        update["document_url"] = loggingDB.escapeString(data.documentUri);
        update["top_document_url"] = loggingDB.escapeString(data.topDocumentUri);
        update["referrer_url"] = loggingDB.escapeString(data.refUrl);
