...
def process_general_mitm_request(db_socket, crawl_id, top_url, msg):
    ...
    data = (crawl_id, msg.request.url, msg.request.method, referrer, encode_to_unicode(str(msg.request.headers)), top_url, str(datetime.datetime.now()))
...
def process_general_mitm_response(db_socket, crawl_id, top_url, msg):
    ...
    data = (crawl_id, msg.request.url, msg.request.method, referrer, msg.response.code, msg.response.msg, encode_to_unicode(str(msg.response.headers)),
