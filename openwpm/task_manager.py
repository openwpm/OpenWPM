...
class TaskManager:
    ...
    def __init__(
        ...
        # Mypy doesn't see the methods generated by dataclass_json
        manager_params = ManagerParamsInternal(**manager_params_temp.to_dict())  # type: ignore
        browser_params = [
            BrowserParamsInternal(**bp.to_dict()) for bp in browser_params_temp  # type: ignore
        ]
