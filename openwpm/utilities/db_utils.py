...
@overload
def query_db(
    db: Path, query: str, params: Any = ..., *, as_tuple: Literal[False] = ...
) -> List[sqlite3.Row]: ...
@overload
def query_db(
...
@overload
def query_db(
    db: Path, query: str, params: Any = ..., *, as_tuple: bool = ...
...
def get_javascript_entries(
    db: Path, all_columns: bool = ..., *, as_tuple: Literal[False] = ...
) -> List[sqlite3.Row]: ...
@overload
def get_javascript_entries(
...
@overload
def get_javascript_entries(
    db: Path, all_columns: bool = ..., *, as_tuple: bool = ...
) -> Union[List[sqlite3.Row], List[Tuple[Any, ...]]]: ...
def get_javascript_entries(
