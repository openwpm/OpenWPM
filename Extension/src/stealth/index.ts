...
function createChangeProperty(window: any) {
  const changeWindowProperty = function (
    object: any,
    name: any,
    type: any,
    changed: any,
    ...
    const original = (descriptor as any)[type];
...
function createProxyFunction(context: any, original: any, replacement: any) {
  if (!changedToStrings.get(context)) {
    ...
    changePropertyFunc(context, {
      ...
      name: "toString",
      type: "value",
      changed: createProxyFunction(context, toString, function (this: any) {
  ...
  handler.apply = exportCustomFunction(
    function (target: any, thisArgs: any, args: any) {
      try {
        return args.length
...
function changePropertyFunc(
  _context: any,
  {
    ...
    type,
    changed,
  }: { object: any; name: any; type: any; changed: any },
) {
  // Removed tracker for changed properties
  const descriptor = Object.getOwnPropertyDescriptor(object, name);
  (descriptor as any)[type] = changed;
  Object.defineProperty(object, name, descriptor as PropertyDescriptor);
}
...
function protectDOMModifications({
  ...
  [
    ...
    protectionDefinition.getters.forEach(function (property) {
      const temp = {
        get [property](): any {
          const ret: any = (this as any)[property];
          allCallback();
          return ret;
        },
      };
...
function protectDocumentWrite({
  ...
  changeWindowProperty(
    ...
    function write(this: any, _markup: any) {
  ...
  changeWindowProperty(
    ...
    function writeln(this: any, _markup: any) {
      for (let i = 0, l = arguments.length; i < l; i += 1) {
        const str = "" + arguments[i];
