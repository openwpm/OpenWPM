...
export default tseslint.config(
  ...
  // Promise plugin recommended rules
  {
    ...
    rules: {
      ...
      // We legitimately use native Promises and construct them directly
      "promise/no-native": "off",
      "promise/avoid-new": "off",
      // Callbacks wrapping async work are common in WebExtension event listeners
  ...
  ...sdlPlugin.configs["common"],

  // Mozilla plugin – selected rules useful for WebExtension development
  {
    plugins: {
      mozilla: mozillaPlugin,
    },
    rules: {
