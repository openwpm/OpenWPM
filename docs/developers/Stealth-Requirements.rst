...
legacy control, because legacy installs the same hook layer and the point here is
to characterise the stealth instrument's own residual surface, not to contrast
it.
